...
if __name__ == "__main__":
    ...
    split["train"]= idx[:train_size]
    split["val"] = idx[train_size: train_size + val_size]
    split["test"] = idx[train_size + val_size:]

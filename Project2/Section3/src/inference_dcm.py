...
This code will do the following:
    ...
    4. Create report    
    from the inferen  Call a shell script to push report to the storage archive
"""
...
def create_report(inference, header, orig_vol, pred_vol):
    ...
    draw.multiline_text((10, 90),
                        ...
                        volume anterior: {inference["anterior"]} 
                        volume posterior: {inference["posterior"]}
...
if __name__ == "__main__":
    ...
    study_dir = [hippo_dir for hippo_dir in subdirs if 'HCrop' in hippo_dir][0]
    ...
    inference_agent = UNetInferenceAgent(
        device="cpu",
        parameter_file_path="./src/model.pth")
    ...
    os_command("storescu 127.0.0.1 4242 -v -aec TESTSCU +r +sd ./src/")
